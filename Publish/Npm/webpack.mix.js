...
// Vue js
mix.js('resources/vendor/TheWatcher/js/app.js', 'public/vendor/TheWatcher/js')
    .vue({version: 3})
    .sourceMaps()
    .version();
const tailwindcss = require('tailwindcss')

mix.sass('resources/vendor/TheWatcher/sass/app.scss', 'public/vendor/TheWatcher/css')
   .options({
